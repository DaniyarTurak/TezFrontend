...
class EsfDetails extends Component {
  state = {
    esf: this.props.esf,
      ...
      <div className="esd-details">
        <div className="row">
          <div className="col-md-12 text-center">
              ...
              <tbody className="text-center">
                ...
                {esf.products.map((product, idx) => (
                  <tr key={idx}>
                    ...
                    <td
                      className={
                        product.ndsRate === "0" || !product.ndsRate ? "" : "tax"
                      }
                    >
                      {product.ndsRate === "0" || !product.ndsRate
                        ? "Без НДС"
                        : product.ndsRate}
                    </td>
                    <td className="tenge">
            ...
            <button className="btn btn-success mt-10" onClick={this.changeEsf}>
              Сохранить изменения
            </button>
          </div>
        </div>
