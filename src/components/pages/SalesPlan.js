							...
							<table className="table table-hover">
								<thead>
									<tr>
										...
										<th className="text-center" colSpan={0} style={{ width: "16%" }}>Еженедневный</th>
										<th className="text-center" colSpan={0} style={{ width: "16%" }}>Месячный</th>
										<th className="text-center" colSpan={0} style={{ width: "16%" }}>Квартальный</th>
							...
							<table className="table table-hover">
								<thead>
									<tr>
										...
										<th className="text-center" style={{ width: "16%" }}>Еженедневный</th>
										<th className="text-center" style={{ width: "16%" }}>Месячный</th>
										<th className="text-center" style={{ width: "16%" }}>Квартальный</th>
