			...
			<Table className={classes.table} aria-label='customized table'>
				...
				<TableRow>
						...
						<TableCell>
							<Autocomplete
								...
								renderInput={params => (
									<TextField
										{...params}
										label={productDetails.unitsprname}
										variant='outlined'
									/>
								)}
							/>
					...
					<TableRow>
						...
						<TableCell></TableCell>
					{/* </TableRow> */}
					{/* {Функцанал по продаже по шуточно,нужно будет добваить, после доработок} */}
					{/* <TableRow>
						<TableCell>
							<Typography variant='h7' align='left'>
								<FormControlLabel
				...
				<TableFooter>
					<TableRow>
						...
						<TableRow>
								...
								<TableCell>
							<Button align='right' onClick={closeModal} variant='contained'>
										Отмена
							</Button>
							</TableCell>
								</TableRow>
